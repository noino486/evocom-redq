...
const DiscordCommunity = () => {
  return (
    <section className="py-10 px-4 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Avec le <span className="font-bold text-accent">Pack Global Business</span>, accédez à notre serveur Discord privé
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-2 border-primary/20">
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="bg-gradient-to-br from-primary via-secondary to-accent p-8 md:p-10 text-white">
                <div className="mb-6">
              ...
              {/* Partie droite - CTA */}
              <div className="p-8 md:p-10 flex flex-col justify-center bg-gradient-to-br from-white to-blue-50">
