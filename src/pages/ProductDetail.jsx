      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            {/* Contact WhatsApp */}
            <div className="bg-gradient-to-br from-green-50/50 to-blue-50/50 backdrop-blur-sm rounded-xl p-6 mb-6 border border-green-200/50">
              <motion.button
                onClick={() => window.open('https://wa.me/33612345678?text=Bonjour, je suis intéressé par le produit ' + encodeURIComponent(product.name), '_blank')}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 shadow-lg shine-effect glow-effect-hover"
              >
